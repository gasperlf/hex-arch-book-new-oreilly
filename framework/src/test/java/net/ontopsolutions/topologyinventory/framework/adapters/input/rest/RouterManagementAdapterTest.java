...
public class RouterManagementAdapterTest {
    ...
    public void retrieveRouter() throws IOException {
        ...
        var routerStr = given()
                ...
                .extract()
                .asString();
        var actualRouterId = getRouterDeserialized(routerStr).getId().getId().toString();
    ...
    public void removeRouterFromCoreRouter() throws IOException {
        ...
        var removedRouterStr = given()
                ...
                .extract()
                .asString();
        var removedRouterId = getRouterDeserialized(removedRouterStr).getId().getId().toString();
