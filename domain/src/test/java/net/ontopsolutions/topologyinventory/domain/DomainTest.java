package net.ontopsolutions.topologyinventory.domain;
...
import net.ontopsolutions.topologyinventory.domain.service.RouterService;
import net.ontopsolutions.topologyinventory.domain.service.SwitchService;
...
public class DomainTest {
    ...
    public void addNetworkToSwitch() {
        ...
        var newNetwork = createTestNetwork("30.0.0.1", 9);
        var networkSwitch = createSwitch("30.0.0.0", 9, location);
