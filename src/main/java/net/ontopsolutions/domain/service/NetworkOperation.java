...
import net.ontopsolutions.domain.specification.CIDRSpecification;
import net.ontopsolutions.domain.specification.NetworkAmountSpecification;
import net.ontopsolutions.domain.specification.NetworkAvailabilitySpecification;
import net.ontopsolutions.domain.specification.RouterTypeSpecification;
