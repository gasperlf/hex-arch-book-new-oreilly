package net.ontopsolutions.framework.adapters.output.kafka;


import net.ontopsolutions.application.ports.output.NotifyEventOutputPort;
import net.ontopsolutions.framework.adapters.input.websocket.WebSocketClientAdapter;
...
public class NotifyEventKafkaAdapter implements NotifyEventOutputPort {
    ...
    private static String KAFKA_BROKERS = "127.0.0.1:29092";
