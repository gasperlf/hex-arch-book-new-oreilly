package net.ontopsolutions.framework.adapters.output.file.mappers;
...
import net.ontopsolutions.framework.adapters.output.file.json.IPJson;
import net.ontopsolutions.framework.adapters.output.file.json.NetworkJson;
import net.ontopsolutions.framework.adapters.output.file.json.RouterJson;
import net.ontopsolutions.framework.adapters.output.file.json.RouterTypeJson;
import net.ontopsolutions.framework.adapters.output.file.json.SwitchJson;
import net.ontopsolutions.framework.adapters.output.file.json.SwitchTypeJson;
